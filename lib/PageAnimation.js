...
function PageAnimation(_a) {
    ...
    var _e = react_1.useState([]), pages = _e[0], setPages = _e[1];
    var history = react_router_dom_1.useHistory();
    react_1.useEffect(function () {
        var unlisten = history.listen(function (location) {
            setPages(function (pages) {
                if (location.pathname === pages[pages.length - 1].location.pathname || !animate)
                    return pages;
                var dir = getDir(location.pathname, pages[pages.length - 1].location.pathname, grid, bias);
    ...
    return (react_1.default.createElement("div", { className: className }, pages.map(function (_a) {
        var Component = _a.Component, className = _a.className, location = _a.location;
        return (react_1.default.createElement(Component, { className: className, key: location.key }));
    })));
}
